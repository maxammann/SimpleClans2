 ...
 */
public class SCClaimingLanguage {
    ...
    public static void setInstance(File folder, Charset charset) {
        LanguageMap defaultBundle = new LanguageMap("/languages/" + DEFAULT_FILE_NAME, true, charset, SCClaimingLanguage.class);
        defaultBundle.load();
        bundle = new LanguageMap(new File(folder, DEFAULT_FILE_NAME).getAbsolutePath(), false, charset, SCClaimingLanguage.class);
