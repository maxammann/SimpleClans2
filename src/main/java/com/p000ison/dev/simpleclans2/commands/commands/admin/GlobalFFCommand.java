...
public class GlobalFFCommand extends GenericConsoleCommand {
    ...
    {
        return ChatColor.DARK_RED + MessageFormat.format(Language.getTranslation("0.globalff.allow.auto.1.set.global.friendly.fire"), plugin.getSettingsManager().getClanCommand());
    }
