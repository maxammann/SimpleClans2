...
public class RivalryBreakRequest extends MultipleRequest {
    ...
    public boolean onAccepted() {
        ...
        if (rival != null && clan != null) {
            ...
            rival.addBBMessage(cp, Language.getTranslation("broken.the.rivalry", clan.getName(), rival.getName()));
            clan.addBBMessage(cp, Language.getTranslation("broken.the.rivalry", clan.getName(), rival.getName()));
